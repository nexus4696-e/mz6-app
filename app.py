...
if st.session_state.page == "home":
    ...
    if not is_adm:
        ...
        if my_early:
            ...
            if early_path:
                ...
                map_url = f"https://www.google.com/maps/dir/?api=1&origin={org_enc}&destination={d_enc}&travelmode=driving&waypoints={wp_enc}"
    ...
    # 👑 管理者フル機能
        ...
        if selected_tab == "① 配車リスト":
            ...
            search_query_reg = st.text_input("🔍 キャスト検索 (名前 または 店番)", placeholder="例: ゆみか, 94", key="search_cast_reg")
            st.markdown('</div>', unsafe_allow_html=True)
