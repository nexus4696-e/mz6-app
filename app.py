...
# 🌟 新機能用：既存のDB構造を壊さず、住所やメモに複数のデータ（託児や当日変更）を隠して保存・復元する処理
...
# ==========================================
# 🎨 カスタムCSS（パスワード破壊・レイアウト崩れを防ぐ安全版を維持）
# ==========================================
st.markdown("""
<style>
