...
import time
import re
import xml.etree.ElementTree as ET  # 🌟 トピックス取得用
...
# ==========================================
# 🌟 ページの設定（アイコン化の完全対応）
# 店長がロリポップに設置した画像のURLを直接指定して確実に表示させます
# ==========================================
st.set_page_config(
    ...
    if not is_adm:
        ...
        if my_early:
            ...
            if early_path:
                ...
                nav_link = f"https://www.google.com/maps/dir/?api=1&origin={org_enc}&destination={d_enc}&travelmode=driving&dir_action=navigate"
            ...
            if earliest_m != 9999:
                ...
                early_html += f"<div style='font-size:15px; font-weight:bold; color:#d32f2f; background:#ffebee; padding:8px; border-radius:5px; margin-bottom:10px; text-align:center;'>🚀 店舗出発 (計算): {dep_time_str}</div>"
        ...
        if my_tasks:
            ...
            if is_return_time:
                ...
                if return_full_path:
                    ...
                    return_map_url = f"https://www.google.com/maps/dir/?api=1&origin={org_enc}&destination={dest_enc}&travelmode=driving&dir_action=navigate"
                ...
                if full_path:
                    ...
                    map_url = f"https://www.google.com/maps/dir/?api=1&origin={org_enc}&destination={dest_enc}&travelmode=driving&dir_action=navigate"
