...
if st.session_state.role is None:
    ...
    with tab_admin:
        ...
        if st.button("ログイン", type="primary", use_container_width=True, key="a_login"):
            admin_correct_pass = db_data['settings'].get('admin_password', 'admin') # 初期パスワードは admin
...
# ==========================================
    ...
    if not attendances:
        ...
        if st.button("💾 すべての変更を保存して反映する", type="primary", use_container_width=True):
